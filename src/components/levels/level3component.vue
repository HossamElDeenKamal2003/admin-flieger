...
export default {
    ...
    methods: {
        async fetchPrices() {
            try {
                const response = await axios.get('http://62.72.16.49:3000/prices/level3/getprices');
        ...
        async handleSubmit() {
            if (this.editMode) {
                try {
                    const response = await axios.patch('http://62.72.16.49:3000/prices/level3/updateprices', this.form);
                ...
                try {
                    const response = await axios.post('http://62.72.16.49:3000/prices/level3/putprices', this.form);
                    alert(response.data.message);
                    this.fetchPrices();
                } catch (error) {
        ...
        deletePrice(country) {
            ...
            if (confirm(`Are you sure you want to delete prices for ${country}?`)) {
                ...
                axios.post('http://62.72.16.49:3000/prices/delete/level3', {
                    country: country
                }).then(() => {
                    this.fetchPrices();
                }).catch(error => {

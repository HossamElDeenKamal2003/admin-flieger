  ...
  data() {
    return {
      menuItems: [
        ...
        {name: 'Special Cases', icon: 'special-cases', route: '/special-cases' },
        ...
        { name: 'Succes Transaction', icon: 'ds', route: '/sucesstrans' },
        { name: 'Level', icon: 'settings', route: '/levels' },
        { name: 'Transaction Requests', icon: 'get req', route: '/get-req' },
